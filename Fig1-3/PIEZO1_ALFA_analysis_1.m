...
% 3 = Yoda1, , 4 = neurite+Yoda1, 5 = cytoD+yoda1
    ...
    Exclude = [9 11 41 43]; %% trimers excluded because the signals are in the soma and not in neurite

    elseif  DataSource == 2
    load("PIEZO1_ALFAmGL_CYTOD_RawData.mat");
             myStruct = PIEZO1_ALFAmGL_CYTOD_RawData;
             result.color = [1 0 0];
        Exclude = [2 10 11 19 22 27 31 43 55 93 103 105 113 124 131 132 135 136 138]'; %% trimers excluded because the signals are not likely in the plasma membrane
   
    elseif  DataSource == 3
    load("PIEZO1_ALFAmGL_Yoda1_RawData.mat");
             myStruct = PIEZO1_ALFAmGL_Yoda1_RawData;
             result.color = [1 0.55 0];
        Exclude = [5 8 21]'; %% trimers excluded because the signals are not likely in the plasma membrane
   
    
    elseif  DataSource == 4
    load("PIEZO1_ALFAmGL_NEURITE_Yoda1_RawData.mat");
             myStruct = PIEZO1_ALFAmGL_NEURITE_Yoda1_RawData;
             result.color = [1 0.6 0];
        Exclude = [44 46 47]'; %% trimers excluded because the signals are not likely in the plasma membrane
   
        elseif  DataSource == 5
    load("PIEZO1_ALFAmGL_CYTOD_Yoda1_RawData.mat");
             myStruct = PIEZO1_ALFAmGL_CYTOD_Yoda1_RawData;
             result.color = [1 0.6 0.6];
        Exclude = [12 14 26 31 35 45]'; %% trimers excluded because the signals are not likely in the plasma membrane
